    ...
    <section className="relative bg-gradient-to-br from-gray-50 via-primary-50 to-secondary-50 py-20 lg:py-32">
      ...
      <Container className="relative">
        <div className="max-w-4xl mx-auto text-center">
          {/* Professional Badge */}
          <div className="inline-flex items-center px-4 py-2 rounded-sm bg-gray-100 text-gray-700 text-sm font-medium mb-8 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mb-4 border border-primary-200">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-secondary-100 rounded-full flex items-center justify-center mb-4 border border-secondary-200">
